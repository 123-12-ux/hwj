...
def get_content(html):
    ...
    for i in dayone:
        temp = []
        if count <= 23:  # 添加时间
            temp.append(i['od21'])  # 添加当前时刻温度
            temp.append(i['od22'])  # 添加当前时刻风力方向
            temp.append(i['od24'])  # 添加当前时刻风级
            temp.append(i['od25'])  # 添加当前时刻降水量
            temp.append(i['od26'])  # 添加当前时刻相对湿度
            temp.append(i['od27'])  # 添加当前时刻控制质量
            temp.append(i['od28'])
            # print(temp)
    ...
    for day in li:
        ...
        if i < 8:
            ...
            # 如果没有风向变化,前后风向一致
                ...
                temp.append(wind)
            # 找到风级
            wind_scale = day.find('span', {'class': 'wind1d'})
            # 找到风级
